...
class ProductSchema extends BaseModel {
  constructor(data, options) {
    super(data, options)
  }
  // Required for $FeathersVuex plugin to work after production transpile.
  static modelName = 'ProductSchema'
...
const servicePath = 'product-schema'//backend services 
const servicePlugin = makeServicePlugin({
  Model: ProductSchema,//className on top
